export default function TermsOfService() {
  return (
    <div style={{ maxWidth: "800px", margin: "40px auto", padding: "20px" }}>
      <h1>Điều Khoản Dịch Vụ – PulseNet</h1>
      <p>Cập nhật lần cuối: {new Date().toLocaleDateString()}</p>

      <p>
        Khi sử dụng PulseNet, bạn đồng ý với các điều khoản sau. Vui lòng đọc kỹ trước
        khi tiếp tục sử dụng dịch vụ.
      </p>

      <h2>1. Chấp nhận điều khoản</h2>
      <p>
        Bằng việc đăng ký hoặc truy cập PulseNet, bạn đồng ý tuân thủ toàn bộ điều khoản
      ...
      <ul>
        ...
        <li>Không sử dụng PulseNet vào mục đích vi phạm pháp luật</li>
      </ul>
      ...
      <p>
        Khi đăng nhập bằng Google hoặc Facebook, bạn đồng ý rằng PulseNet có thể
      ...
      <p>Cảm ơn bạn đã sử dụng PulseNet.</p>
    </div>
  );
}
